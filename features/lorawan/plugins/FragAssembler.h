...
#ifndef _MBED_OS_FEATURES_LORAWAN_PLUGINSFRAGMENTATION_MATH
#define _MBED_OS_FEATURES_LORAWAN_PLUGINSFRAGMENTATION_MATH
...
#endif // _MBED_OS_FEATURES_LORAWAN_PLUGINSFRAGMENTATION_MATH
